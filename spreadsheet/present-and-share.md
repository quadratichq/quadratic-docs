...
1. [Present your data directly:](present-and-share.md#present-your-data) make your spreadsheet more viewable while not editing.
2. [Visualize your data:](present-and-share.md#visualize-your-data) turn raw data into beautiful visualizations.&#x20;
3. [Share your work:](present-and-share.md#share-your-work) let others play with and edit your work as a team.&#x20;
4. [Copy as PNG:](present-and-share.md#copy-as-png) copy and paste data into any presentation, design tool, or anywhere else you'd want to share your PNG.
5. [Embed as an iFrame:](present-and-share.md#embed-in-a-webpage-via-iframe) get your spreadsheets into any page on the web.
...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><span data-gb-custom-inline data-tag="emoji" data-code="1f4ca">📊</span> <strong>Learn how to:</strong> <br>Create visualizations in Quadratic -></td><td></td><td></td><td><a href="../python/charts-visualizations.md">charts-visualizations.md</a></td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td><td></td></tr></tbody></table>

## 3. Share your work

By sharing, you allow other users to view your sheet, code, etc.&#x20;

<figure><img src="../.gitbook/assets/CleanShot 2024-01-22 at 14.48.13@2x (1).png" alt=""><figcaption></figcaption></figure>
